...
export class PhoneCartDetails extends Component{
    ...
    componentDidMount(){
        ...
        const sock = new SockJS(RestUrls.SOCKET_URL);
        ...
        <NavigationBar {...this.props } display='none' />
            <div className="flex  justify-center items-center flex-col">
                ...
                <div className="m-5">
                    ...
                    </button>                    {/* <Link className={ this.getLinkClasses() } to="/momocad/checkout">SEND</Link> */}
                    ...
                    {/* <a className="inline-flex items-center justify-center p-5 text-base cursor-pointer font-medium text-gray-500 rounded-lg bg-gray-50 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700 dark:hover:text-white mr-2  focus:cursor-mouse" onClick={() => {
